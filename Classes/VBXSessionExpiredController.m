...
- (void)loadView {
    ...
    _logoutButton = [[VBXButtonCell alloc] initWithText:LocalizedString(@"Use a different email address", @"Session Expired: Label for login w/ a different email button.") reuseIdentifier:nil];
